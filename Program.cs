...
{
    Console.WriteLine();
    Console.WriteLine("Commands: listcustomer, addcustomer, editcustomer, deletecustomer, listorders, orderdetails, addorder, productpages, listcategory, addcategory, editcategory, deletecategory, exit ");
